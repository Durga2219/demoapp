...
import { useGetDriverBookingsQuery, useConfirmBookingMutation, useCancelBookingMutation } from '../app/api/bookingApi';
...
const DriverBookingsPage = () => {
  const { data: driverBookings, isLoading, refetch } = useGetDriverBookingsQuery();
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="max-w-6xl mx-auto p-6">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-gray-900">Driver Bookings</h1>
          <button
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            <p className="text-gray-600 mb-4">No bookings found for your rides.</p>
            <button
      ...
      {showCancelModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <h2 className="text-xl font-bold mb-4">Cancel/Reject Booking</h2>
